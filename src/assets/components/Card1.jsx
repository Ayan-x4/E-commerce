...
const Card1 = () => {
 ...
 useEffect(() => {
      ...
      <div className="flex md:gap-3 gap-2">
        {Array(8)
          ...
          .map((_, i) => (
            <div
              key={i}
              className="md:h-[150px] h-[100px] md:w-[150px] w-[100px] rounded-full bg-gray-200 animate-pulse"
            >
              <div className="h-[100px] md:h-[150px] rounded-full bg-gray-300"></div>
  ...
  return (
    ...
    <div className={`md:h-[120px] md:w-[120px]  rounded-[50%]   items-center justify-center flex bg-[#F5F5F5] md:border-transparent md:border-[0px] border-1 md:shadow-[0px_1px_5px_0.1px_rgb(0,0,0,0.2)]  border-[#008ECC] hover:border-[#008ECC] duration-200 cursor-pointer shadow-none hover:shadow-[0_0_18px_#008ECC,0_0_5px_#008ECC] duration-300 ${theme}`}>
      <div className="h-[100px]  w-[100px] md:p-1 p-[4px] flex items-center ">
        <img
        src={card.image}
        alt=""
      ></img>
