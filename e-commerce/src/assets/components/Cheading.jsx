...
const Cheading = (props) => {
  return (
    <>
      <h1 className='md:font-medium font-bold text-[#666666] md:text-2xl text-[12px] underline decoration-[#008ECC] md:underline-offset-15 underline-offset-10 md:decoration-5 decoration-2 cursor-pointer'>{props.name}<span className='md:font-medium text-[#008ECC] md:text-2xl cursor-pointer'>{props.pro}</span></h1>
